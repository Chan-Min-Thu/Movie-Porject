...
const AiringTodayTv = () => {
  ...
  <div className="bg-background w-full h-auto">
    ...
    <div className="flex flex-row flex-wrap md:justify-start justify-center w-11/12 h-[500px] overflow-scroll scrollbar-thin m-auto">
    {isFetching?<h1 className="text-whiteColor text-3xl">Loading</h1>:data?.results.map(movie => <TvCard key={movie.id} data={movie}/>)
